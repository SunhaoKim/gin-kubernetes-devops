...
var BaseMenus = []model.SysBaseMenu{
	...
	{GVA_MODEL: global.GVA_MODEL{ID: 15, CreatedAt: time.Now(), UpdatedAt: time.Now()}, MenuLevel: 0, Hidden: false, ParentId: "2", Path: "k8sCluster", Name: "k8sCluster", Component: "view/kubernetes/clusters/index.vue", Sort: 0, Meta: model.Meta{Title: "集群管理", Icon: "menu"}},
	...
	{GVA_MODEL: global.GVA_MODEL{ID: 19, CreatedAt: time.Now(), UpdatedAt: time.Now()}, MenuLevel: 0, Hidden: false, ParentId: "2", Path: "k8sNodes", Name: "k8sNodes", Component: "view/kubernetes/nodes/k8sNodes.vue", Sort: 1, Meta: model.Meta{Title: "节点管理", Icon: "s-grid"}},
