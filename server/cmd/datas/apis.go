...
var Apis = []model.SysApi{
	...
	{global.GVA_MODEL{ID: 44, CreatedAt: time.Now(), UpdatedAt: time.Now()}, "/k8sDeployments/restartK8sDeployment", "重启Deployments", "k8sDeployments", "PUT"},
	...
	{global.GVA_MODEL{ID: 54, CreatedAt: time.Now(), UpdatedAt: time.Now()}, "/k8sPods/getPodLog", "获取Pod日志", "k8sPods", "GET"},
	{global.GVA_MODEL{ID: 55, CreatedAt: time.Now(), UpdatedAt: time.Now()}, "/k8sNodes/getK8sNodesList", "获取节点", "k8sNodes", "GET"},
	{global.GVA_MODEL{ID: 56, CreatedAt: time.Now(), UpdatedAt: time.Now()}, "/container/execContainer", "进入容器", "container", "GET"},
}
