    ...
    <div>
            ...
            >
                <template slot-scope="scope">
                    <el-popover
                        ...
                        placement="top-start"
                        trigger="hover"
                        :content="scope.row.kubeConfig"
                    >
                        <span slot="reference" class="btn">{{
                            scope.row.kubeConfig
                        }}</span>
                    </el-popover>
                </template>
            </el-table-column>
        ...
        >
            ...
            >
                ...
                >
                    <el-input
                        v-model="formData.k8sVersion"
                        placeholder="请输入k8s版本"
                        :style="{ width: '100%' }"
                    ></el-input>
                </el-form-item>
            </el-form>
